...
Hexkit's interfaces for the pattern are the [DAO Publisher](../protocols/daopublisher.qmd)
protocol on the producing side and the [DAO Subscriber](../protocols/daosubscriber.qmd)
protocol on the consuming side; each has its own chapter.
