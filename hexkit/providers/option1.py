...
class KafkaEventPublisherCM:
    """Manages setup and teardown of KafkaEventPublisher instances."""

    _producer: KafkaProducerCompatible
    ...
    async def __aenter__(
        ...
        *,
        ...
        """Setup KafkaEventPublisher instance with some config params.
        ...
        return KafkaEventPublisher(producer=self._producer)

    async def __aexit__(self, exc_type, exc_value, exc_trace):
        """Teardown KafkaEventPublisher instance."""
